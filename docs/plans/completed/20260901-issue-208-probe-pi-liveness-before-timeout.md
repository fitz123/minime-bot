...
- [x] Replace the fallback removal text in `CHANGELOG.md`, run both focused test files and typecheck, then perform a final diff/privacy cut: no workflow coupling, heartbeat, configuration, new subsystem, status change, unrelated hunk, or private data.
