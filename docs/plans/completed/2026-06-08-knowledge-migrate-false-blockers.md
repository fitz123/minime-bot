...
Status: complete. Addresses GitHub issue #9.
...
- [x] When a legacy/pre-v2 workspace already has non-v2 `wiki/schema.md`, `wiki/index.md`, `wiki/log.md`, or existing `wiki/issues.md`, plan archive copies under `artifacts/`.
